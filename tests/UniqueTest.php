...
final class UniqueTest extends TestCase
{
    ...
    {
        $result = unique(input: [3, 1, 4, 1, 5, 9, 2], flags: SORT_NUMERIC);
    ...
    {
        $result = unique(['a' => 3, 'b' => 1, 'c' => 4, 'd' => 1, 'e' => 5], flags: SORT_NUMERIC);
    ...
    {
        $result = unique([3, 1, 4, 1, 5, 9, 2], flags: SORT_NUMERIC, mode: Mode::MODE_ASSOC);
    ...
    {
        $result = unique(['3', '1', '4', '1', '5', '9', '2'], flags: SORT_STRING, mode: Mode::MODE_LIST);
    ...
    {
        $result = unique([3, 1, '4', '1', 5, 9, '2', 6, 5.0, 3, '5']);
    ...
    {
        $result = unique(['3', '1', '4', '1', '5', '9', '2'], strict: true, mode: Mode::MODE_LIST);
    ...
    public function testUniqueObjectWithStrictWithAutoMode(): void
    {
        ...
        $result = unique([$obj1, $obj2, $obj3], strict: true);
    ...
    {
        $result = unique([1, 1, 1, 1, 1, 1], true);
    ...
    {
        $result = unique([1, [1.25, 1.5, ['1.75']], [1.25, 1.5, ['1.75']], 2, ['value' => 2.5], ['value' => 2.5], 3]);
    ...
    public function testListWithResourceWithStrictWithAutoMode(): void
    {
        ...
        $result = unique([$resource, $resource], true);
